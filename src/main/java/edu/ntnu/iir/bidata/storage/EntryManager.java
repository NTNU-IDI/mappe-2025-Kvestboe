...
public class EntryManager {
     ...
     *
     * @param entryID the id(key) of the diary
     * @return an entry
     */
    ...
    /**
     * Getter for entries with title,
     * if the entry contains(not equal) the title.
     *
    ...
    /**
     * Getter for the entries with tag,
     * if the entry tags contains(not equal) the tag.
     *
